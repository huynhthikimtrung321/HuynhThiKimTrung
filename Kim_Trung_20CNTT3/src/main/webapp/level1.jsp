...
<body>
<h1 > Processor </h1>
<form NAME="information" method = get action ="information1.jsp">
...
<h2> <h1> Accessories</h1></h2>
<input name="type" type="checkbox" value="Monitor" />Monitor<br>
<input name="type" type="checkbox" value="Camera" />Camera<br>
<input name="type" type="checkbox" value="Printer" />Monitor<br>
<input name="type" type="checkbox" value="Scanner" />Monitor<br>
 <br></br>
